...
package fs // import "memfs/fuse/fs"
...
func (s *Server) Serve(fs FS) error {
	...
	log.Printf("Serve, curRoot:%+v", root)
...
func (c *Server) serve(r fuse.Request) {
	log.Printf("serve, fuse.Request:%+v", r)
	...
	log.Printf("serve, serveRequest:%+v", req)
...
func (c *Server) handleRequest(ctx context.Context, node Node, snode *serveNode, r fuse.Request, done func(resp interface{})) error {
	log.Printf("handleRequest, fuse.Request:%+v", r)
	switch r := r.(type) {
	default:
	...
	case *fuse.StatfsRequest:
		log.Println("handleRequest, type is:fuse.StatfsRequest")
	...
	case *fuse.GetattrRequest:
		log.Println("handleRequest, type is:fuse.GetattrRequest")
	...
	case *fuse.SetattrRequest:
		log.Println("handleRequest, type is:fuse.SetattrRequest")
	...
	case *fuse.SymlinkRequest:
		log.Println("handleRequest, type is:fuse.SymlinkRequest")
	...
	case *fuse.ReadlinkRequest:
		log.Println("handleRequest, type is:fuse.ReadlinkRequest")
	...
	case *fuse.LinkRequest:
		log.Println("handleRequest, type is:fuse.LinkRequest")
	...
	case *fuse.RemoveRequest:
		log.Println("handleRequest, type is:fuse.RemoveRequest")
	...
	case *fuse.AccessRequest:
		log.Println("handleRequest, type is:fuse.AccessRequest")
	...
	case *fuse.LookupRequest:
		log.Println("handleRequest, type is:fuse.LookupRequest")
		var n2 Node
		var err error
		s := &fuse.LookupResponse{}
		initLookupResponse(s)
	...
	case *fuse.MkdirRequest:
		log.Println("handleRequest, type is:fuse.MkdirRequest")
	...
	case *fuse.OpenRequest:
		log.Println("handleRequest, type is:fuse.OpenRequest")
		s := &fuse.OpenResponse{}
		var h2 Handle
	...
	case *fuse.CreateRequest:
		log.Println("handleRequest, type is:fuse.CreateRequest")
	...
	case *fuse.GetxattrRequest:
		log.Println("handleRequest, type is:fuse.GetxattrRequest")
	...
	case *fuse.ListxattrRequest:
		log.Println("handleRequest, type is:fuse.ListxattrRequest")
	...
	case *fuse.SetxattrRequest:
		log.Println("handleRequest, type is:fuse.SetxattrRequest")
	...
	case *fuse.RemovexattrRequest:
		log.Println("handleRequest, type is:fuse.RemovexattrRequest")
	...
	case *fuse.ForgetRequest:
		log.Println("handleRequest, type is:fuse.ForgetRequest")
	...
	case *fuse.BatchForgetRequest:
		log.Println("handleRequest, type is:fuse.BatchForgetRequest")
	...
	case *fuse.ReadRequest:
		log.Println("handleRequest, type is:fuse.ReadRequest")
		...
		if r.Dir {
			log.Println("handleRequest, type is:fuse.ReadRequest, is dir")
			...
			log.Println("handleRequest, type is:fuse.ReadRequest, is not dir")
	...
	case *fuse.WriteRequest:
		log.Println("handleRequest, type is:fuse.WriteRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.FlushRequest:
		log.Println("handleRequest, type is:fuse.FlushRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.ReleaseRequest:
		log.Println("handleRequest, type is:fuse.ReleaseRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.DestroyRequest:
		log.Println("handleRequest, type is:fuse.DestroyRequest")
	...
	case *fuse.RenameRequest:
		log.Println("handleRequest, type is:fuse.RenameRequest")
		c.meta.Lock()
	...
	case *fuse.MknodRequest:
		log.Println("handleRequest, type is:fuse.MknodRequest")
	...
	case *fuse.FsyncRequest:
		log.Println("handleRequest, type is:fuse.FsyncRequest")
	...
	case *fuse.InterruptRequest:
		log.Println("handleRequest, type is:fuse.InterruptRequest")
		c.meta.Lock()
		ireq := c.req[r.IntrID]
	...
	case *fuse.PollRequest:
		log.Println("handleRequest, type is:fuse.PollRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.NotifyReply:
		log.Println("handleRequest, type is:fuse.NotifyReply")
		c.notifyMu.Lock()
	...
	case *fuse.LockRequest:
		log.Println("handleRequest, type is:fuse.LockRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.LockWaitRequest:
		log.Println("handleRequest, type is:fuse.LockWaitRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.UnlockRequest:
		log.Println("handleRequest, type is:fuse.UnlockRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
	...
	case *fuse.QueryLockRequest:
		log.Println("handleRequest, type is:fuse.QueryLockRequest")
		shandle := c.getHandle(r.Handle)
		if shandle == nil {
			return syscall.ESTALE
		}
